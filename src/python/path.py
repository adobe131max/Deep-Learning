...
file_path = os.path.join(cwd, './src/python/path.py')
print(file_path)
assert os.path.exists(file_path), './src/python/path.py not found.'    # 可以识别/和\
...
assert os.path.exists('./src/python/path.py'), './src/python/path.py not found.'
